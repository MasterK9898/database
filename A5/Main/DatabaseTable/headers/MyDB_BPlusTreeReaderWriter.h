...
private:
	...
	void discoverPages(int whichPage, vector<MyDB_PageReaderWriter> &list,
	...
	// combine the logic of get range interoator (sort and not sort)
	MyDB_RecordIteratorAltPtr unifiedGetRangeIteratorAltHelper(MyDB_AttValPtr low, MyDB_AttValPtr high, bool sort);
