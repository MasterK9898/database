...
// basically we will take in another logical operation, and then we will convert it into a table and scanout the result
// this is useful for converting a join into a table, so that we can then run a selection on top of it
class LogicalConvertScan : public LogicalOp
{
public:
