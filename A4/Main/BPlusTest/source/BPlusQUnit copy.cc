...
int main(int argc, char *argv[])
{
	...
	MyDB_TablePtr myTable = make_shared<MyDB_Table>("supplierSimple", "supplierSimple.bin", mySchema);
	...
	case 1:
	{
		cout << "TEST 1... creating tree for small table, on suppkey " << endl;
		...
		supplierTable.loadFromTextFile("supplierSimple.tbl");
